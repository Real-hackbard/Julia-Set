...
uses
  ...
  Vcl.ComCtrls, Vcl.Shell.ShellCtrls, XPman, Vcl.ExtCtrls, Vcl.StdCtrls,
  Vcl.Grids, Vcl.Menus;
...
procedure TForm1.MaPanelResize(Sender: TObject);
var bb,hh,i:integer;
begin
...
procedure TForm1.superMousedown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
...
begin
    ...
    begin
      ...
      0 : if (sender as tpaintbox)= mandel1 then nr:=1;
      1 : if (sender as tpaintbox)= mandel2 then nr:=2;
      2 : if (sender as tpaintbox)= mandel3 then nr:=3;
      3 : if (sender as tpaintbox)= mandel4 then nr:=4;
      4 : if (sender as tpaintbox)= mandel5 then nr:=5;
      5 : if (sender as tpaintbox)= mandel6 then nr:=6;
      end;
...
begin
  ...
  begin
    try
      Bitmap:=TBitmap.Create;
      Bitmap.PixelFormat := pf24bit;
      Bitmap.Width:=mandel1.Width;
      Bitmap.Height:=mandel1.Height;
      Bitmap.Canvas.CopyRect(Bounds(0,0,bitmap.Width, Bitmap.Height),
        mandel1.Canvas, mandel1.ClientRect);
...
begin
  ...
  begin
    try
      Bitmap:=TBitmap.Create;
      Bitmap.PixelFormat := pf24bit;
      Bitmap.Width:=mandel2.Width;
      Bitmap.Height:=mandel2.Height;
      Bitmap.Canvas.CopyRect(Bounds(0,0,bitmap.Width, Bitmap.Height),
        mandel2.Canvas, mandel2.ClientRect);
...
begin
  ...
  begin
    try
      Bitmap:=TBitmap.Create;
      Bitmap.PixelFormat := pf24bit;
      Bitmap.Width:=mandel3.Width;
      Bitmap.Height:=mandel3.Height;
      Bitmap.Canvas.CopyRect(Bounds(0,0,bitmap.Width, Bitmap.Height),
        mandel3.Canvas, mandel3.ClientRect);
...
begin
  ...
  begin
    try
      Bitmap:=TBitmap.Create;
      Bitmap.PixelFormat := pf24bit;
      Bitmap.Width:=mandel4.Width;
      Bitmap.Height:=mandel4.Height;
      Bitmap.Canvas.CopyRect(Bounds(0,0,bitmap.Width, Bitmap.Height),
        mandel4.Canvas, mandel4.ClientRect);
...
begin
  ...
  begin
    try
      Bitmap:=TBitmap.Create;
      Bitmap.PixelFormat := pf24bit;
      Bitmap.Width:=mandel5.Width;
      Bitmap.Height:=mandel5.Height;
      Bitmap.Canvas.CopyRect(Bounds(0,0,bitmap.Width, Bitmap.Height),
        mandel5.Canvas, mandel5.ClientRect);
...
begin
  ...
  begin
    try
      Bitmap:=TBitmap.Create;
      Bitmap.PixelFormat := pf24bit;
      Bitmap.Width:=mandel6.Width;
      Bitmap.Height:=mandel6.Height;
      Bitmap.Canvas.CopyRect(Bounds(0,0,bitmap.Width, Bitmap.Height),
        mandel6.Canvas, mandel6.ClientRect);
...
begin
    ...
    if timer1.enabled then button1.caption:='Cancel'
                      else button1.caption:='Color Animation';
end;
